package de.designwerk09.view.components.buttons
{
	...
	public class MainMenuTextButton extends Sprite
	{
		...
		private var _normal:Number = 0xABCA58;
		private var _over:Number = 0xCFE1A0;
		private var _aktiv:Number = 0xFFFFFF;

		public function MainMenuTextButton(txt:String, name:String, font:String, size:int, id:int)
		{
		...
		private function initbtn():void{
			clickbtn.graphics.beginFill(0x82CC60, 0);
		...
		private function over(e:MouseEvent):void{
			if (!_onoff){
	           //	Tweener.addTween(label, {_color:_over, time:.5, transition:"easeoutquad"});
