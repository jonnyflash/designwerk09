package de.designwerk09.controller
{
	...
	public class RightboxCommand extends SimpleCommand implements ICommand
	{
		...
		override public function execute(notification:INotification):void {
			var menuStatus:RightboxProxy = facade.retrieveProxy(RightboxProxy.NAME) as RightboxProxy;
